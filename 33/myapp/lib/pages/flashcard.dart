...
class _FlashcardState extends State<Flashcard> {
  List<Map<String, dynamic>> _cardKanjiList = [
    {"text": "日", "meaning": "Sun/Day", "katakana": "ニチ", "hiragana": "ひひ", "isFavorite": false},
    {"text": "月", "meaning": "Moon", "katakana": "ゲツ", "hiragana": "つき", "isFavorite": false},
    {"text": "本", "meaning": "Book", "katakana": "ホン", "hiragana": "もと", "isFavorite": false},
    {"text": "青", "meaning": "Moon", "katakana": "セイ", "hiragana": "あお", "isFavorite": false},
    {"text": "本", "meaning": "Book", "katakana": "ホン", "hiragana": "もと", "isFavorite": false},
    {"text": "青", "meaning": "Moon", "katakana": "セイ", "hiragana": "あお", "isFavorite": false},
  ];
  bool isView = true;
                ...
                children: [
                  Container(
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        setState(() {
                          _cardKanjiList[index]["isFavorite"] = ! _cardKanjiList[index]["isFavorite"];
                        });
                      },
                      icon:_cardKanjiList[index]["isFavorite"] == false
                          ? Icon(Icons.star_border, color: Colors.red, size: 40)
